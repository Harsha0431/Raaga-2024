...
<template>
    <div class="min-h-[100vh] event-list-container bg-[#1a332d] flex flex-col gap-8 justify-center py-4 ssm:pb-12 px-8">
        ...
        <span class="text-center font-montserrat  font-extrabold tracking-wide text-[40px] sm:text-[46px] relative mt-[74px]"> Raaga Events</span>
